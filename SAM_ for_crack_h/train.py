...
parser.add_argument('--root_path', type=str,
                    default='/home/lifeiyang/SAMed_fortest/train/samed_traindat1', help='root dir for data')
parser.add_argument('--output', type=str, default='/home/lifeiyang/SAMed_fortest/train_output')
...
parser.add_argument('--max_epochs', type=int,
                    default=31, help='maximum epoch number to train')
